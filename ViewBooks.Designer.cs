namespace Lib1
{
    partial class ViewBooks
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnReserveVwBks = new SiticoneNetCoreUI.SiticoneButton();
            ...
            // btnReserveVwBks
            // 
            btnReserveVwBks.AccessibleDescription = "The default button control that accept input though the mouse, touch and keyboard";
            btnReserveVwBks.AccessibleName = "Reserve";
            btnReserveVwBks.AutoSizeBasedOnText = false;
            btnReserveVwBks.BackColor = Color.Transparent;
            btnReserveVwBks.BadgeBackColor = Color.Red;
            btnReserveVwBks.BadgeFont = new Font("Segoe UI", 8F, FontStyle.Bold);
            btnReserveVwBks.BadgeValue = 0;
            btnReserveVwBks.BadgeValueForeColor = Color.White;
            btnReserveVwBks.BorderColor = Color.Transparent;
            btnReserveVwBks.BorderWidth = 2;
            btnReserveVwBks.ButtonBackColor = Color.FromArgb(255, 128, 0);
            btnReserveVwBks.ButtonImage = null;
            btnReserveVwBks.CanBeep = true;
            btnReserveVwBks.CanGlow = false;
            btnReserveVwBks.CanShake = true;
            btnReserveVwBks.ContextMenuStripEx = null;
            btnReserveVwBks.CornerRadiusBottomLeft = 8;
            btnReserveVwBks.CornerRadiusBottomRight = 8;
            btnReserveVwBks.CornerRadiusTopLeft = 8;
            btnReserveVwBks.CornerRadiusTopRight = 8;
            btnReserveVwBks.CustomCursor = Cursors.Default;
            btnReserveVwBks.DisabledTextColor = Color.FromArgb(150, 150, 150);
            btnReserveVwBks.EnableLongPress = false;
            btnReserveVwBks.EnablePressAnimation = true;
            btnReserveVwBks.EnableRippleEffect = true;
            btnReserveVwBks.EnableShadow = false;
            btnReserveVwBks.EnableTextWrapping = false;
            btnReserveVwBks.Font = new Font("Segoe UI", 9F);
            btnReserveVwBks.GlowColor = Color.FromArgb(100, 255, 255, 255);
            btnReserveVwBks.GlowIntensity = 100;
            btnReserveVwBks.GlowRadius = 20F;
            btnReserveVwBks.GradientBackground = false;
            btnReserveVwBks.GradientColor = Color.FromArgb(114, 168, 255);
            btnReserveVwBks.GradientMode = System.Drawing.Drawing2D.LinearGradientMode.Vertical;
            btnReserveVwBks.HintText = null;
            btnReserveVwBks.HoverBackColor = Color.FromArgb(114, 168, 255);
            btnReserveVwBks.HoverFontStyle = FontStyle.Regular;
            btnReserveVwBks.HoverTextColor = Color.White;
            btnReserveVwBks.HoverTransitionDuration = 250;
            btnReserveVwBks.ImageAlign = ContentAlignment.MiddleLeft;
            btnReserveVwBks.ImagePadding = 5;
            btnReserveVwBks.ImageSize = new Size(16, 16);
            btnReserveVwBks.IsRadial = false;
            btnReserveVwBks.IsReadOnly = false;
            btnReserveVwBks.IsToggleButton = false;
            btnReserveVwBks.IsToggled = false;
            btnReserveVwBks.Location = new Point(748, 649);
            btnReserveVwBks.LongPressDurationMS = 1000;
            btnReserveVwBks.Name = "btnReserveVwBks";
            btnReserveVwBks.NormalFontStyle = FontStyle.Regular;
            btnReserveVwBks.ParticleColor = Color.FromArgb(200, 200, 200);
            btnReserveVwBks.ParticleCount = 15;
            btnReserveVwBks.PressAnimationScale = 0.97F;
            btnReserveVwBks.PressedBackColor = Color.FromArgb(74, 128, 235);
            btnReserveVwBks.PressedFontStyle = FontStyle.Regular;
            btnReserveVwBks.PressTransitionDuration = 150;
            btnReserveVwBks.ReadOnlyTextColor = Color.FromArgb(100, 100, 100);
            btnReserveVwBks.RippleColor = Color.FromArgb(255, 255, 255);
            btnReserveVwBks.RippleOpacity = 0.3F;
            btnReserveVwBks.RippleRadiusMultiplier = 0.6F;
            btnReserveVwBks.ShadowBlur = 5;
            btnReserveVwBks.ShadowColor = Color.FromArgb(100, 0, 0, 0);
            btnReserveVwBks.ShadowOffset = new Point(2, 2);
            btnReserveVwBks.ShakeDuration = 500;
            btnReserveVwBks.ShakeIntensity = 5;
            btnReserveVwBks.Size = new Size(85, 42);
            btnReserveVwBks.TabIndex = 58;
            btnReserveVwBks.Text = "Reserve";
            btnReserveVwBks.TextAlign = ContentAlignment.MiddleCenter;
            btnReserveVwBks.TextColor = Color.White;
            btnReserveVwBks.TooltipText = null;
            btnReserveVwBks.UseAdvancedRendering = true;
            btnReserveVwBks.UseParticles = false;
            btnReserveVwBks.Click += btnReserveVwBks_Click;
            // 
        ...
        private SiticoneNetCoreUI.SiticoneButton btnReserveVwBks;
